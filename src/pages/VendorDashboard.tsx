...
import { IndianRupee, CalendarCheck, Clock, Star, Check, X, TrendingUp, Users, Loader2, Wallet, AlertTriangle, Bell } from "lucide-react";
...
const VendorDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-24 max-w-lg mx-auto">
      {/* Header */}
      <header className="bg-primary px-4 py-6 rounded-b-3xl relative">
